...
//        for Test
        Optional<List<Follow>> optionalFollows= Optional.ofNullable(getFollowerListForTesting());
...
//    doUnfollowingOthers
    private static Long getFollowerId(FollowingRequestDto requestDto, List<Follow> follows) {
        ...
        if (index == -1L) System.err.println("follows isEmpty");
        return index;
    }
...
//        For Test
        Optional<List<Follow>> removedFollowsOptional= Optional.ofNullable(getFollowerListForTesting());
